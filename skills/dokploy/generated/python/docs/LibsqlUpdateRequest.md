...
**sqld_node** | **str** |  | [optional] 
**sqld_primary_url** | **str** |  | [optional] 
**enable_namespaces** | **bool** |  | [optional] [default to False]
**docker_image** | **str** |  | [optional] [default to 'ghcr.io/tursodatabase/libsql-server:v0.24.32']
...
json = "{}"
# create an instance of LibsqlUpdateRequest from a JSON string
libsql_update_request_instance = LibsqlUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(LibsqlUpdateRequest.to_json())

# convert the object into a dict
libsql_update_request_dict = libsql_update_request_instance.to_dict()
# create an instance of LibsqlUpdateRequest from a dict
libsql_update_request_from_dict = LibsqlUpdateRequest.from_dict(libsql_update_request_dict)
```
