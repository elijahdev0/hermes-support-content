...
class TestUserCreateUserWithCredentialsRequest(unittest.TestCase):
    """UserCreateUserWithCredentialsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCreateUserWithCredentialsRequest:
        """Test UserCreateUserWithCredentialsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserCreateUserWithCredentialsRequest`
        """
        model = UserCreateUserWithCredentialsRequest()
        if include_optional:
            return UserCreateUserWithCredentialsRequest(
    ...
    def testUserCreateUserWithCredentialsRequest(self):
        """Test UserCreateUserWithCredentialsRequest"""
