...
class TestBitbucketUpdateRequest(unittest.TestCase):
    """BitbucketUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BitbucketUpdateRequest:
        """Test BitbucketUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BitbucketUpdateRequest`
        """
        model = BitbucketUpdateRequest()
        if include_optional:
            return BitbucketUpdateRequest(
                bitbucket_id = '0',
                bitbucket_username = '',
    ...
    def testBitbucketUpdateRequest(self):
        """Test BitbucketUpdateRequest"""
