...
class TestBitbucketCreateRequest(unittest.TestCase):
    """BitbucketCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BitbucketCreateRequest:
        """Test BitbucketCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BitbucketCreateRequest`
        """
        model = BitbucketCreateRequest()
        if include_optional:
            return BitbucketCreateRequest(
                bitbucket_id = '',
                bitbucket_username = '',
    ...
    def testBitbucketCreateRequest(self):
        """Test BitbucketCreateRequest"""
