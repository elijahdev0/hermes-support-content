...
class TestRedisApi(unittest.TestCase):
    ...
    def test_redis_change_password(self) -> None:
        """Test case for redis_change_password
    ...
    def test_redis_move(self) -> None:
        """Test case for redis_move
    ...
    def test_redis_read_logs(self) -> None:
        """Test case for redis_read_logs

        """
        pass

    def test_redis_rebuild(self) -> None:
        """Test case for redis_rebuild
    ...
    def test_redis_search(self) -> None:
        """Test case for redis_search
