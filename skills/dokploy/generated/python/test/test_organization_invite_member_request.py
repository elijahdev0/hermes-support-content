...
class TestOrganizationInviteMemberRequest(unittest.TestCase):
    """OrganizationInviteMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationInviteMemberRequest:
        """Test OrganizationInviteMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationInviteMemberRequest`
        """
        model = OrganizationInviteMemberRequest()
        if include_optional:
            return OrganizationInviteMemberRequest(
    ...
    def testOrganizationInviteMemberRequest(self):
        """Test OrganizationInviteMemberRequest"""
