...
class CertificatesApi:
    ...
    def certificates_one(
        self,
        certificate_id: Optional[Annotated[str, Field(min_length=1, strict=True)]],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def certificates_update(
        self,
        certificates_update_request: CertificatesUpdateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param certificates_update_request: (required)
        :type certificates_update_request: CertificatesUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._certificates_update_serialize(
            certificates_update_request=certificates_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _certificates_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if certificates_update_request is not None:
            _body_params = certificates_update_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/certificates.update',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
