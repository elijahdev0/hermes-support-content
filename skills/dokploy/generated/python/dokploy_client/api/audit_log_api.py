...
class AuditLogApi:
    ...
    def audit_log_all(
        ...
        _param = self._audit_log_all_serialize(
            user_id=user_id,
    ...
    @validate_call
    def audit_log_all_with_http_info(
        self,
        user_id: Optional[StrictStr] = None,
        user_email: Optional[StrictStr] = None,
        resource_name: Optional[StrictStr] = None,
    ...
    @validate_call
    def audit_log_all_without_preload_content(
        self,
        user_id: Optional[StrictStr] = None,
        user_email: Optional[StrictStr] = None,
        resource_name: Optional[StrictStr] = None,
