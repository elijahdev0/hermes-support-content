...
class CustomRoleUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    role_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="roleName")
    new_role_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=50)]] = Field(default=None, alias="newRoleName")
    permissions: Dict[str, List[StrictStr]]
    __properties: ClassVar[List[str]] = ["roleName", "newRoleName", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newRoleName": obj.get("newRoleName"),
