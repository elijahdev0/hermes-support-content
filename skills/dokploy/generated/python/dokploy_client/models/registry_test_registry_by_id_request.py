...
class RegistryTestRegistryByIdRequest(BaseModel):
    """
    RegistryTestRegistryByIdRequest
    """ # noqa: E501
    registry_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="registryId")
    server_id: Optional[StrictStr] = Field(default=None, alias="serverId")
    __properties: ClassVar[List[str]] = ["registryId", "serverId"]
