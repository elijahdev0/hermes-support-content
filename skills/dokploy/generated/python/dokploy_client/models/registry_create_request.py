...
class RegistryCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    registry_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="registryName")
    ...
    image_prefix: Optional[StrictStr] = Field(alias="imagePrefix")
    server_id: Optional[StrictStr] = Field(default=None, alias="serverId")
    __properties: ClassVar[List[str]] = ["registryName", "username", "password", "registryUrl", "registryType", "imagePrefix", "serverId"]
