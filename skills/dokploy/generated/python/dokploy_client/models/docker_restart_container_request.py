...
class DockerRestartContainerRequest(BaseModel):
    """
    DockerRestartContainerRequest
    """ # noqa: E501
    container_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="containerId")
    server_id: Optional[StrictStr] = Field(default=None, alias="serverId")
    __properties: ClassVar[List[str]] = ["containerId", "serverId"]
