...
class MariadbUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    mariadb_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="mariadbId")
    ...
    database_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="databaseName")
    ...
    database_root_password: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="databaseRootPassword")
    ...
    __properties: ClassVar[List[str]] = ["mariadbId", "name", "appName", "description", "databaseName", "databaseUser", "databasePassword", "databaseRootPassword", "dockerImage", "command", "args", "env", "memoryReservation", "memoryLimit", "cpuReservation", "cpuLimit", "externalPort", "applicationStatus", "healthCheckSwarm", "restartPolicySwarm", "placementSwarm", "updateConfigSwarm", "rollbackConfigSwarm", "modeSwarm", "labelsSwarm", "networkSwarm", "stopGracePeriodSwarm", "endpointSpecSwarm", "ulimitsSwarm", "replicas", "createdAt", "environmentId"]
    ...
    @field_validator('database_root_password')
    def database_root_password_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
