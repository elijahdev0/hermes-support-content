...
class OrganizationUpdateMemberRoleRequest(BaseModel):
    """
    OrganizationUpdateMemberRoleRequest
    """ # noqa: E501
    member_id: Optional[StrictStr] = Field(alias="memberId")
    role: Optional[Annotated[str, Field(min_length=1, strict=True)]]
