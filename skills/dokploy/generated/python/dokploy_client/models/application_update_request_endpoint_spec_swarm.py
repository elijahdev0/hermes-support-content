...
class ApplicationUpdateRequestEndpointSpecSwarm(BaseModel):
    """
    ApplicationUpdateRequestEndpointSpecSwarm
    """ # noqa: E501
    mode: Optional[StrictStr] = Field(default=None, alias="Mode")
    ports: Optional[List[ApplicationUpdateRequestEndpointSpecSwarmPortsInner]] = Field(default=None, alias="Ports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Mode": obj.get("Mode"),
            "Ports": [ApplicationUpdateRequestEndpointSpecSwarmPortsInner.from_dict(_item) for _item in obj["Ports"]] if obj.get("Ports") is not None else None
        })
