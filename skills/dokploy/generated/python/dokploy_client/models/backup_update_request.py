...
class BackupUpdateRequest(BaseModel):
    ...
    backup_id: Optional[StrictStr] = Field(alias="backupId")
    ...
    keep_latest_count: Optional[Union[StrictFloat, StrictInt]] = Field(alias="keepLatestCount")
    service_name: Optional[StrictStr] = Field(alias="serviceName")
    metadata: Optional[Any]
    database_type: StrictStr = Field(alias="databaseType")
    __properties: ClassVar[List[str]] = ["schedule", "enabled", "prefix", "backupId", "destinationId", "database", "keepLatestCount", "serviceName", "metadata", "databaseType"]
