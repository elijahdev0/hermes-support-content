...
class ForwardAuthDeployOnServerRequest(BaseModel):
    """
    ForwardAuthDeployOnServerRequest
    """ # noqa: E501
    server_id: Optional[StrictStr] = Field(alias="serverId")
    provider_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="providerId")
    __properties: ClassVar[List[str]] = ["serverId", "providerId"]
