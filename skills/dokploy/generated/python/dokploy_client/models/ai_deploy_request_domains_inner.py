...
class AiDeployRequestDomainsInner(BaseModel):
    """
    ...
    service_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="serviceName")
    __properties: ClassVar[List[str]] = ["host", "port", "serviceName"]
