...
class MongoUpdateRequest(BaseModel):
    ...
    MongoUpdateRequest
    """ # noqa: E501
    mongo_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="mongoId")
    ...
    replica_sets: Optional[StrictBool] = Field(default=False, alias="replicaSets")
    __properties: ClassVar[List[str]] = ["mongoId", "name", "appName", "description", "databaseUser", "databasePassword", "dockerImage", "command", "args", "env", "memoryReservation", "memoryLimit", "cpuReservation", "cpuLimit", "externalPort", "applicationStatus", "healthCheckSwarm", "restartPolicySwarm", "placementSwarm", "updateConfigSwarm", "rollbackConfigSwarm", "modeSwarm", "labelsSwarm", "networkSwarm", "stopGracePeriodSwarm", "endpointSpecSwarm", "ulimitsSwarm", "replicas", "createdAt", "environmentId", "replicaSets"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if replica_sets (nullable) is None
        # and model_fields_set contains the field
        if self.replica_sets is None and "replica_sets" in self.model_fields_set:
            _dict['replicaSets'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "replicaSets": obj.get("replicaSets") if obj.get("replicaSets") is not None else False
        })
        return _obj
