...
Hint: If you need to reference the generated domain in the preview deployment's environment variables, you can do so utilising`${{DOKPLOY_DEPLOY_URL}}`. See variables documentation for more information.
...
RollbacksLearn how to rollback your application in Dokploy.

### On this page

ConfigurationCustom DomainsHow It WorksFiltering labelsMonitoring DeploymentsAutomatic UpdatesManual Rebuilds