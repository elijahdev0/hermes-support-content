...
It Have a endpoint called`health` endpoint which is the one that will tell us if our application is healthy.
...
Going ProductionLearn how to deploy your application in production in Dokploy.

### On this page

Steps to configure Zero Downtime DeploymentsExample