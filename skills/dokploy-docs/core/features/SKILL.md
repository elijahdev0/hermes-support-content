...
source: "https://docs.dokploy.com/docs/core/features"
...
Architecture of DokployOverview of the core architecture components of Dokploy.

ComparisonA comparison of Dokploy, CapRover, Dokku, and Coolify

### On this page

Application DeploymentApplications ManagementDocker Compose ManagementDatabase Deployment