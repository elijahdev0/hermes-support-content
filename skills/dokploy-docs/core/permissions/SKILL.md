...
source: "https://docs.dokploy.com/docs/core/permissions"
...
GitlabConfigure Gitlab repositories for deployments. This includes setting up access tokens, repository names, and branches.

OverviewConfigure general notifications for your applications and services.

### On this page

RolesOwnerAdminMembersPermissionsProject PermissionsEnterprise: Custom Roles & Additional Permissions