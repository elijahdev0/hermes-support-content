...
```
curl -X POST "https://your-dokploy-instance.com/api/sshKey.create" \  -H "Content-Type: application/json" \  -d '{    "name": "string",    "privateKey": "string",    "publicKey": "string",    "organizationId": "string"  }'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/sshKey.remove" \  -H "Content-Type: application/json" \  -d '{    "sshKeyId": "string"  }'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/sshKey.generate" \  -H "Content-Type: application/json" \  -d '{}'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/sshKey.update" \  -H "Content-Type: application/json" \  -d '{    "sshKeyId": "string"  }'
```
