...
source: "https://docs.dokploy.com/docs/api/certificates"
...
```
curl -X POST "https://your-dokploy-instance.com/api/certificates.update" \  -H "Content-Type: application/json" \  -d '{    "certificateId": "string"  }'
```
