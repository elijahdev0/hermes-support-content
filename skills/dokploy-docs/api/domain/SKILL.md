---
title: "Domain | Dokploy"
source: "https://docs.dokploy.com/docs/api/domain"
...
```
curl -X POST "https://your-dokploy-instance.com/api/domain.create" \  -H "Content-Type: application/json" \  -d '{    "host": "string"  }'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/domain.generateDomain" \  -H "Content-Type: application/json" \  -d '{    "appName": "string"  }'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/domain.update" \  -H "Content-Type: application/json" \  -d '{    "host": "string",    "domainId": "string"  }'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/domain.delete" \  -H "Content-Type: application/json" \  -d '{    "domainId": "string"  }'
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/domain.validateDomain" \  -H "Content-Type: application/json" \  -d '{    "domain": "string"  }'
```
