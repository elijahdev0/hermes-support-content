...
source: "https://docs.dokploy.com/docs/api/postgres"
...
```
curl -X POST "https://your-dokploy-instance.com/api/postgres.changePassword" \  -H "Content-Type: application/json" \  -d '{    "postgresId": "string",    "password": "string"  }'
```
...
```
curl -X GET "https://your-dokploy-instance.com/api/postgres.search"
```
...
```
curl -X GET "https://your-dokploy-instance.com/api/postgres.readLogs?postgresId=string"
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/postgres.changePassword" \
  -H "Content-Type: application/json" \
  -d '{
    "postgresId": "string",
    "password": "string"
