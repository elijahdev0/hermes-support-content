---
title: "Redis | Dokploy"
source: "https://docs.dokploy.com/docs/api/redis"
...
```
curl -X POST "https://your-dokploy-instance.com/api/redis.changePassword" \  -H "Content-Type: application/json" \  -d '{    "redisId": "string",    "password": "string"  }'
```
...
```
curl -X GET "https://your-dokploy-instance.com/api/redis.search"
```
...
```
curl -X GET "https://your-dokploy-instance.com/api/redis.readLogs?redisId=string"
```
...
```
curl -X POST "https://your-dokploy-instance.com/api/redis.changePassword" \
  -H "Content-Type: application/json" \
  -d '{
    "redisId": "string",
    "password": "string"
