...
```
curl -X POST "https://your-dokploy-instance.com/api/github.update" \  -H "Content-Type: application/json" \  -d '{    "githubId": "string",    "name": "string",    "gitProviderId": "string",    "githubAppName": "string"  }'
```
