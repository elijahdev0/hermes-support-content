---
title: "Mounts | Dokploy"
source: "https://docs.dokploy.com/docs/api/mounts"
...
```
curl -X GET "https://your-dokploy-instance.com/api/mounts.listByServiceId?serviceType=string&serviceId=string"
```
